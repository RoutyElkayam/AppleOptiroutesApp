(function () {
  'use strict';
		...
		// 	baseUrl = "http://192.168.8.100/or-il/dev";		
		// else if(window.location.hostname.includes('192.168.43.210'))
		// 		baseUrl = "http://192.168.43.210/or-il/dev";
		// else if(window.location.hostname.includes('176.13.131.126'))
		// 	baseUrl = "http://176.13.131.126/or-il/dev";
		// else if(window.location.hostname.includes('127.0.0.1'))
		// 	baseUrl = "https://check.optiroutes.com/dev";
		// else if(window.location.hostname.includes('localhost') && window.location.port==8080)
		// 	baseUrl = "https://check.optiroutes.com/dev";
		// else if(window.location.hostname.includes('localhost'))
		// 	baseUrl = "http://localhost/or-il/dev";
		...
		baseUrl = "https://check.optiroutes.com/dev";
		// else
		// 	baseUrl = "https://optiroutes.com/dev";
